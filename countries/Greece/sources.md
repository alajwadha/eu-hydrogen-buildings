...
- Greece-specific bioenergy and heating data
...
Sources for the bottom-up heat-demand build (`el.yaml`, methodology in
`literature/greece/classification_methodology.md`):
...
- **Greek TABULA typology (NOA / NTUA / CRES)** — per-class × per-cohort space-heating energy need (Zone B reference). https://episcope.eu/building-typology/country/gr/ ; Dascalaki, Balaras et al. *MDPI Applied Sciences* 11(14):6254 (2021). See `code/data/raw/tabula/el_intensities.csv`.
- **Eurostat `nrg_chdd_a`** — heating degree days (base 15 °C, JRC AGRI4CAST); 2022 confirmed 1538, 5-year mean estimated 1600. https://ec.europa.eu/eurostat/databrowser/view/nrg_chdd_a
- **Exoikonomo programme reporting** — retrofit-state assumptions (~1% deep-renovated stock).
