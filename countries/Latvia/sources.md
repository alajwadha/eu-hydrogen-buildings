...
- Latvia-specific bioenergy and heating data
...
Sources for the bottom-up heat-demand build (`lv.yaml`, methodology in
`literature/latvia/classification_methodology.md`):
...
- **Poland TABULA typology (NAPE)** — used as the climate-corrected proxy; the Polish TABULA Scientific Report (NAPE). https://episcope.eu/building-typology/country/pl/ . See `code/data/raw/tabula/pl_intensities.csv`.
- **Eurostat `nrg_chdd_a`** — heating degree days (base 15 °C, JRC AGRI4CAST), 2018–2022 mean: Latvia 3818.3, Poland 3158.7. https://ec.europa.eu/eurostat/databrowser/view/nrg_chdd_a
- **Latvian Long-Term Renovation Strategy** and ALTUM apartment-renovation programme reporting — retrofit-state assumptions.
- **Latvia CSB 2021 Population and Housing Census** — residential stock age structure.
