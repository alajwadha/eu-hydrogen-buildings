...
- Portugal-specific bioenergy and heating data
...
Sources for the bottom-up heat-demand build (`pt.yaml`, methodology in
`literature/portugal/classification_methodology.md`):

- **EUBUCCO v0.2** — Milojevic-Dupont N. et al. (2023), *Scientific Data* 10:147, DOI 10.1038/s41597-023-02040-2. https://eubucco.com/files/v0.2 (ODbL v1.0). EUBUCCO flags Portugal as lower-coverage (OSM-derived in rural areas).
- **Spanish TABULA typology (CIEMAT)** — used as the climate-corrected proxy (shared Iberian construction tradition). See `code/data/raw/tabula/es_intensities.csv`.
- **Eurostat `nrg_chdd_a`** — heating degree days (base 15 °C, JRC AGRI4CAST); PT 2020 = 1008, 2022 = 968; 5-year mean estimated 1050. ES 5-year mean estimated 1750. PT/ES HDD ratio 0.6000. https://ec.europa.eu/eurostat/databrowser/view/nrg_chdd_a
- **Casa Eficiente 2020, Fundo Ambiental, E-Lar (PRR)** and INE Censos 2021 — retrofit-state and stock-age assumptions.
