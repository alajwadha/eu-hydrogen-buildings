...
- Croatia-specific bioenergy and heating data
...
Sources for the bottom-up heat-demand build (`hr.yaml`, methodology in
`literature/croatia/classification_methodology.md`):

- **EUBUCCO v0.2** — Milojevic-Dupont N. et al. (2023), *Scientific Data* 10:147, DOI 10.1038/s41597-023-02040-2. https://eubucco.com/files/v0.2 (ODbL v1.0). EUBUCCO flags Croatia as a low-coverage country.
- **Slovenian TABULA typology (ZRMK)** — used as the climate-corrected proxy (shared Yugoslav-era construction tradition). See `code/data/raw/tabula/si_intensities.csv`.
- **Eurostat `nrg_chdd_a`** — heating degree days (base 15 °C, JRC AGRI4CAST), 2018–2022 mean: Croatia 2197.99, Slovenia 2693.30. https://ec.europa.eu/eurostat/databrowser/view/nrg_chdd_a
- **Croatian Long-Term Renovation Strategy** — retrofit-state assumptions.
