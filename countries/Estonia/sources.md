...
- Estonia-specific bioenergy and heating data
...
Sources for the bottom-up heat-demand build (`ee.yaml`, methodology in
`literature/estonia/classification_methodology.md`):
...
- **Eurostat `nrg_chdd_a`** — heating degree days (base 15 °C, JRC AGRI4CAST), 2018–2022 mean: Estonia 3987.8, Poland 3158.7. https://ec.europa.eu/eurostat/databrowser/view/nrg_chdd_a
- **Estonian Long-Term Renovation Strategy (2020)** and KredEx apartment-renovation programme reporting — retrofit-state assumptions.
- **Statistics Estonia 2021 Census** — residential stock age structure.
