...
- Lithuania-specific bioenergy and heating data
...
Sources for the bottom-up heat-demand build (`lt.yaml`, methodology in
`literature/lithuania/classification_methodology.md`):
...
- **Eurostat `nrg_chdd_a`** — heating degree days (base 15 °C, JRC AGRI4CAST), 2018–2022 mean: Lithuania 3639.5, Poland 3158.7. https://ec.europa.eu/eurostat/databrowser/view/nrg_chdd_a
- **Lithuanian Long-Term Renovation Strategy (2020)** and APVA multi-apartment renovation programme reporting — retrofit-state assumptions.
- **Statistics Lithuania** — residential stock age structure.
